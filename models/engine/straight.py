...
class StraightEngine(Engine):
    ...
    def get_discard_cards(self, card_in_hand, remaining_cards):
        best_straight_low_value = self.get_best_low_value(card_in_hand)
        best_straight = StraightService.next_5_values(best_straight_low_value)
    ...
    @classmethod
    def get_best_low_value(cls, card_in_hand):
        straight_score = {}
        for value in Value.ALL_STRAIGHT_LOW_VALUES:
